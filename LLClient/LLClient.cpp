...
// LLClient.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CLLClientApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CLLClientApp construction

CLLClientApp::CLLClientApp()
{
...
BOOL CLLClientApp::InitInstance()
{
